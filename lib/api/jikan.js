...
export class JikanClient {
  ...
  formatAnimeData(anime) {
    return {
      ...
      releaseYear: anime.aired?.from ? new Date(anime.aired.from).getFullYear() : null,
  ...
  formatMangaData(manga) {
    return {
      ...
      releaseYear: manga.published?.from ? new Date(manga.published.from).getFullYear() : null,

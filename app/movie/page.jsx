...
export default function MoviesPage() {
  ...
  const stats = calculateMediaStats(userMedia, 'movie');
  ...
  const handleIncreaseProgress = async (userMediaId) => {
    try {
      await increaseProgress(userMediaId, 'movie');
    } catch (error) {
  ...
  const handleDeleteClick = async (itemId) => {
    const result = await showConfirmDialog({
      ...
      text: 'Tem certeza que deseja remover este filme da sua lista?',
      icon: 'warning',
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center py-16 fade-in">
          ...
          <p className="text-white/60 text-lg">Carregando seus filmes...</p>
        </div>
      </div>
    );
  }
            ...
            <div className="mb-8 glass rounded-2xl p-6 border border-white/10">
              <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                <div className="flex items-center gap-4">
                  <div className="p-3 rounded-lg w-12 h-12 flex items-center justify-center bg-gradient-to-br from-blue-500/20 to-teal-500/20">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 mt-2">
                      Gerencie sua lista de filmes, acompanhe progresso e avaliações
                    </p>
                  </div>
                </div>
              ...
              <div className="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                <div>
                  <p className="text-white/80 text-sm">
                    ...
                    {' filme'}{filteredMedia.length !== 1 ? 's' : ''}
                      ...
                      <div className="text-center py-16 fade-in">
                        <div className="glass border border-white/10 rounded-2xl p-12 max-w-md mx-auto">
                          ...
                          <p className="text-white/60 mb-8">
                            {searchQuery
                              ? `Não foi possível encontrar filmes com o título "${searchQuery}"`
                              : 'Não foi possível encontrar filmes correspondentes aos filtros selecionados'
                            }
                          </p>
                          <div className="flex flex-col sm:flex-row gap-3 justify-center">
                            ...
                            <Button
                              ...
                              onClick={handleRefresh}
                              icon={RefreshCw}
                              className="bg-gradient-to-r from-blue-500 to-teal-500 hover:from-blue-600 hover:to-teal-600 min-w-[180px]"
                            >
                              Recarregar Página
                            </Button>
                          </div>
